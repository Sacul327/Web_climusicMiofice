  ...
  <body class="text-center">
	...
	<form class="form-signin" action="ServletMain" method="post">
		...
		<a class="navbar-brand" href="#"><img
			src="images/ClimusiclogoCortado.jpg" class="img-responsive pos"
			style="width: 100%" alt="Image"></a> <font color="#17a2b8" size="4"
			face="Arial"> Usuario o contraseña incorrecto.</font>
		<h3 class="h6 mb-3 font-weight-normal">Please sign in</h3>
		<label for="inputEmail" class="sr-only">Email address</label> <input
			name="email" type="email" id="inputEmail" class="form-control mb-2"
			placeholder="Email address" required autofocus> <label
			for="inputPassword" class="sr-only">Password</label> <input
			name="password" type="password" id="inputPassword"
			class="form-control mb-2" placeholder="Password" required>
		<button class="btn btn-lg btn-info btn-block bg-red" type="submit">Sign
			in</button>
